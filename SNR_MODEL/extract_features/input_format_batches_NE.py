...
# this script was used to extract the relevant annotated NEs from the files 'trainAfterRules_26_07_2021_cor_READY', 'valAfterRules_26_07_2021_cor_READY','testAfterRules_26_07_2021_cor_READY' that had all the annotated concepts. So that an input file for the NE related models could be used as input (defined in experiments.conf file)
